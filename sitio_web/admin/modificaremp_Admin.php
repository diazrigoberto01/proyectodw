...
>>>>>>> bddd171ac8cbd710ab919a332678a0a71e3add33
    ...
    <form action="modificaremp_Admin.php" method="POST" onsubmit="return valida()">
      <table>
        ...
        <tr>
          <td>Email:</td>
          <td><input type="text" required name="email" id="" placeholder="Email" value="<?php echo $row[4]?>" /></td>
        </tr>
        <tr>
          <td>Pais</td>
          <td><input type="text" required name="pais" id="" placeholder="Pais" value="<?php echo $row[9]?>"/></td>
        </tr>
        <tr>
          <td>Estado</td>
          <td>
            <input type="text" required name="estado" id="" placeholder="Estado" value="<?php echo $row[8]?>"/>
          </td>
        </tr>
        <tr>
          <td>Municipio</td>
          <td>
            <input type="text" required name="municipio" id="" placeholder="Municipio" value="<?php echo $row[7]?>"/>
          </td>
        </tr>
        <tr>
          <td>Calle</td>
          <td><input type="text" required name="calle" id="" placeholder="Calle" value="<?php echo $row[5]?>"/></td>
        </tr>
        <tr>
          <td>Nº Exterior</td>
          <td>
            <input type="text" required name="n_ext" id="" placeholder="Nº Exterior" value="<?php echo $row[10]?>"/>
          </td>
        </tr>
        <tr>
          <td>Nº Interior</td>
        ...
        <tr>
          <td>Localidad</td>
          <td>
            <input type="text" required name="localidad" id="" placeholder="Localidad" value="<?php echo $row[6]?>"/>
          </td>
        </tr>
        <tr>
          <td>CP</td>
          <td><input type="text" required name="cp" id="" placeholder="CP" value="<?php echo $row[11]?>"/></td>
        </tr>
