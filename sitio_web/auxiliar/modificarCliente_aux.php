...
<html lang="es">
  ...
  <body>
    ...
    if($_GET["id"]){
      ...
      header("Location: clientes_aux.php");
    }
    ...
    ?>
    <form action="modificarCliente_aux.php" method="post" onsubmit="return valida()">
      <table>
          <tr>
            <td>RFC:</td>
            <td>
              <input type="text" name="rfcCliente" placeholder="RFC" value="<?php echo $row[0]?>" disabled/>
            </td>
          </tr>
          <tr>
            <td>Razon Social:</td>
          ...
          <tr>
            <td>Telefono:</td>
            <td><input type="text" name="tel" id="" placeholder="Telefono" value="<?php echo $row[3]?>" disabled/></td>
          </tr>
          <tr>
            <td colspan="2">
