        ...
        <div class="col-md-10  align-self-end">
          ...
          <div class="row">
            <div class="col align-self-center">
              <form class="needs-validation" name="cliente" action="agregar-cliente.php" method="post" enctype="multipart/form-data" novalidate>
                <!-- Fila -->
                <div class="form-row">
                  <div class="col-md-6 mb-3">
                    <label for="rfcCliente">RFC</label>
                    <input type="text" class="form-control" name="rfcCliente" id="rfcCliente" placeholder="RFC" pattern="[A-Z0-9]{10,20}" required>
