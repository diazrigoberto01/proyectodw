        ...
        <div class="col">
          <div class="row">
            <div class="col align-self-center mb-3 mt-3">
              <h1 style="color: red;">NO ESTÁ HECHO, ESTO ES DE CLIENTE</h1>
              <h2>Nueva Factura</h2>
            </div>
          </div>
          <div class="row">
            <div class="col align-self-center">
              <form class="needs-validation" name="factura" action="agregar-factura.php" method="post" novalidate>
                <!-- Fila -->
                <div class="form-row">
                  <div class="col-md-6 mb-3">
                    <label for="rfcFactura">RFC</label>
                    <input type="text" class="form-control" name="rfcFactura" id="rfcFactura" placeholder="RFC" pattern="[A-Z0-9]{10,20}" required>
